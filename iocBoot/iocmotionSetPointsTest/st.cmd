...
motionSetPointsConfigure("LOOKUPFILE1DAXIS","LOOKUPFILE1DAXIS")
...
motionSetPointsConfigure("LOOKUPFILE2DAXIS","LOOKUPFILE2DAXIS")

epicsEnvSet("LOOKUPFILEDN","${TOP}/iocBoot/${IOC}/duplicate_names.txt")
motionSetPointsConfigure("LOOKUPFILEDN","LOOKUPFILEDN")

epicsEnvSet("LOOKUPFILEDP","${TOP}/iocBoot/${IOC}/duplicate_positions.txt")
motionSetPointsConfigure("LOOKUPFILEDP","LOOKUPFILEDP")
