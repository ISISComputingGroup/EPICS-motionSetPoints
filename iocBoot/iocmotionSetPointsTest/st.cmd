...
# Analyser
dbLoadRecords("$(TOP)/db/motionSetPoints.db","P=$(MYPVPREFIX)LKUP:MSP:,TARGET_PV1=$(MYPVPREFIX)MSP:MTR0,TARGET_RBV1=$(MYPVPREFIX)MSP:MTR0.RBV,TARGET_DONE=$(MYPVPREFIX)MSP:MTR0.DMOV,TARGET_DONE2=$(MYPVPREFIX)MSP:MTR1.DMOV,TOL=1,LOOKUP=LOOKUPFILE1")
dbLoadRecords("$(TOP)/db/single_axis.db","P=$(MYPVPREFIX)LKUP:MSP:,AXIS_NUM=1,TARGET_PV=$(MYPVPREFIX)MSP:MTR1,TARGET_RBV=$(MYPVPREFIX)MSP:MTR1.RBV,TARGET_DONE=$(MYPVPREFIX)MSP:MTR1.DMOV,LOOKUP=LOOKUPFILE1")
...
# 2D no axis
dbLoadRecords("$(TOP)/db/motionSetPoints.db","P=$(MYPVPREFIX)LKUP:2D:,TARGET_PV1=$(MYPVPREFIX)MSP:MTR0,TARGET_RBV1=$(MYPVPREFIX)MSP:MTR0.RBV,TARGET_DONE=$(MYPVPREFIX)MSP:MTR0.DMOV,TARGET_DONE2=$(MYPVPREFIX)MSP:MTR1.DMOV,TOL=1,LOOKUP=LOOKUPFILE2D")
dbLoadRecords("$(TOP)/db/single_axis.db","P=$(MYPVPREFIX)LKUP:2D:,AXIS_NUM=1,TARGET_PV=$(MYPVPREFIX)MSP:MTR1,TARGET_RBV=$(MYPVPREFIX)MSP:MTR1.RBV,TARGET_DONE=$(MYPVPREFIX)MSP:MTR1.DMOV,LOOKUP=LOOKUPFILE2D")
