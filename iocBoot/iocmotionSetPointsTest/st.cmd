...
# Analyser
dbLoadRecords("$(TOP)/db/motionSetPointsDoubleAxis.db","P=$(MYPVPREFIX)LKUP:MSP:,TARGET_PV1=$(MYPVPREFIX)MSP:MTR0,TARGET_PV2=$(MYPVPREFIX)MSP:MTR1,TARGET_RBV1=$(MYPVPREFIX)MSP:MTR0.RBV,TARGET_RBV2=$(MYPVPREFIX)MSP:MTR1.RBV,TARGET_DONE=$(MYPVPREFIX)MSP:MTR0.DMOV,TARGET_DONE2=$(MYPVPREFIX)MSP:MTR1.DMOV,TOL=1,LOOKUP=LOOKUPFILE1")

# 1D no axis
dbLoadRecords("$(TOP)/db/motionSetPointsSingleAxis.db","P=$(MYPVPREFIX)LKUP:1D:,TARGET_PV1=$(MYPVPREFIX)MSP:MTR0,TARGET_RBV1=$(MYPVPREFIX)MSP:MTR0.RBV,TARGET_DONE=$(MYPVPREFIX)MSP:MTR0.DMOV,TOL=1,LOOKUP=LOOKUPFILE1D")

# 2D no axis
dbLoadRecords("$(TOP)/db/motionSetPointsDoubleAxis.db","P=$(MYPVPREFIX)LKUP:2D:,TARGET_PV1=$(MYPVPREFIX)MSP:MTR0,TARGET_PV2=$(MYPVPREFIX)MSP:MTR1,TARGET_RBV1=$(MYPVPREFIX)MSP:MTR0.RBV,TARGET_RBV2=$(MYPVPREFIX)MSP:MTR1.RBV,TARGET_DONE=$(MYPVPREFIX)MSP:MTR0.DMOV,TARGET_DONE2=$(MYPVPREFIX)MSP:MTR1.DMOV,TOL=1,LOOKUP=LOOKUPFILE2D")
