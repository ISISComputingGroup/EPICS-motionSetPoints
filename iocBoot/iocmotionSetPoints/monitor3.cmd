...
dbLoadRecords("db/setPoint.db","P=$(MYPVPREFIX)LKUP:MON3:,NP=40,TARGET_PV1=$(MYPVPREFIX)MTR01,TARGET_RBV1=$(MYPVPREFIX)MTR01.RBV,TARGET_DONE=$(MYPVPREFIX)MTR01.DMOV")
