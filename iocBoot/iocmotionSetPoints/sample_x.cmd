...
dbLoadRecords("db/setPoint.db","P=$(MYPVPREFIX)LKUP:SAMPX:,NP=100,TARGET_PV1=$(MYPVPREFIX)MTR03,TARGET_RBV1=$(MYPVPREFIX)MTR03.RBV,TARGET_DONE=$(MYPVPREFIX)MTR03.DMOV,FILTER_SRC=$(MYPVPREFIX)LKUP:SAMPY:FILTER:OUT,TOL=1")
